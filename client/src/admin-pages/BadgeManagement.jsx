  ...
  return (
    <>
      ...
      <div className="badge-management-page admin-container">
        <Header pageTitle="Badge Management" adminName="Admin Name" />
        ...
        <div className="badgemanagement-page-scaler">
          <div className="responsive-wrapper">
            <div className="badge-management-grid">
                    ...
                    {badges.length === 0 ? (
                      <div className="empty-placeholder">
                        ...
                        <p className="placeholder-text">
                          No recent badges yet. Be the first to add one!
                        </p>
                      </div>
                    ) : (
              ...
              <div
                className={`badge-form-section grid-col-3 ${!isPanelOpen ? "panel-closed" : ""}`}
              >
                <h3>
                  {selectedBadge?.id === "new"
                    ? "Add New Badge"
                    ...
                    <div className="form-inputs">
                      ...
                      <div className="input-group">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setMilestoneCondition(e.target.value)
                          }
                          required
                        />
                      </div>
